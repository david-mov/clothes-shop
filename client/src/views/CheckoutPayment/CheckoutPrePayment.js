                ...
                <table1 className="table1">
                  <thead className="table1__thead1">
                    <tr>
                      ...
                      <th colspan="5" className="table1__th">
                        Sizes to Item
                      </th>
                  ...
                  <tbody className="table1__tbody">{bodyTable()}</tbody>
                </table1>
                <div className="pagar">
                  <h5 className="row__title">Total items: {miBasket}</h5>
                  <h5 className="row__title">
                    Total Amount: {parseInt(total)}
                  </h5>
                  <form
    ...
    <div>
      ...
      <div>
        {!datos ? (
          ...
          <div className="boton_pagar"> {FormRow()} </div>
        )}
      </div>
    </div>
  );
